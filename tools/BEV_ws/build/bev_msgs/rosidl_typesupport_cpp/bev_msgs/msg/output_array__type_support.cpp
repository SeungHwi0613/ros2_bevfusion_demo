...
static const _OutputArray_type_support_symbol_names_t _OutputArray_message_typesupport_symbol_names = {
  {
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, bev_msgs, msg, OutputArray)),
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_cpp, bev_msgs, msg, OutputArray)),
  }
};
...
{
  return &::bev_msgs::msg::rosidl_typesupport_cpp::OutputArray_message_type_support_handle;
}
...
ROSIDL_TYPESUPPORT_CPP_PUBLIC
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_cpp, bev_msgs, msg, OutputArray)() {
  return get_message_type_support_handle<bev_msgs::msg::OutputArray>();
}
